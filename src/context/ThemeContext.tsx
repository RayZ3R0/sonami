...
// Theme registry - initialized with default and all imported themes
...
const THEME_STORAGE_KEY = "spotist-theme";
...
const applyThemeToDocument = (theme: Theme) => {
    ...
    root.style.setProperty("--theme-interactive-active", colors.interactiveActive);
    ...
    root.style.setProperty("--theme-progress-fill-gradient", colors.progressFillGradient);
...
export const ThemeProvider = ({ children }: { children: ReactNode }) => {
    ...
    const [themeRegistry, setThemeRegistry] = useState<Record<string, Theme>>(themes);
    ...
    return (
        <ThemeContext.Provider value={{ theme, themeId, availableThemes, setTheme, registerTheme }}>
            {children}
