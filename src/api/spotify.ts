...
export async function fetchSpotifyPlaylist(
  ...
  return await invoke<SpotifyPlaylistResult>("fetch_spotify_playlist", {
    urlOrId,
  });
}
...
export async function verifySpotifyTrack(
  ...
  return await invoke<VerifiedSpotifyTrack>("verify_spotify_track", {
    title,
    artist,
  });
}
...
export async function verifySpotifyTracks(
  ...
  return await invoke<VerifiedSpotifyTrack[]>("verify_spotify_tracks", {
    tracks,
  });
}
