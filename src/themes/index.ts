 ...
 * SPOTIST THEMES
 * 
 * All themes converted from RGB to hex format and mapped to the theme token structure.
 * Each theme provides a complete, cohesive color palette.
 */

// ============================================
// CATPPUCCIN LATTE (Light)
// ============================================
export const catppuccinLatte = createTheme("catppuccin-latte", "Catppuccin Latte", {
    background: "#eff1f5",
...
// ============================================
export const catppuccinFrappe = createTheme("catppuccin-frappe", "Catppuccin Frappé", {
    background: "#303446",
...
// ============================================
export const catppuccinMacchiato = createTheme("catppuccin-macchiato", "Catppuccin Macchiato", {
    background: "#24273a",
...
// ============================================
export const catppuccinMocha = createTheme("catppuccin-mocha", "Catppuccin Mocha", {
    background: "#1e1e2e",
...
// SOLARIZED LIGHT
// ============================================
export const solarizedLight = createTheme("solarized-light", "Solarized Light", {
    background: "#fdf6e3",
...
// ============================================
export const cottonCandyDreams = createTheme("cotton-candy-dreams", "Cotton Candy Dreams", {
    background: "#ffe1ed",
