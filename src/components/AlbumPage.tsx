      ...
      try {
        if (providerId === "tidal") {
          ...
          const [albumData, tracksData] = await Promise.all([
            ...
            invoke<TidalTrack[]>("tidal_get_album_tracks", {
              albumId: numericId,
            }),
          ]);
    ...
    <div className="h-full overflow-y-auto">
      <div className="relative">
        <div
          ...
          style={{
            backgroundImage: album.cover ? `url(${album.cover})` : undefined,
          }}
        />
      ...
      <div className="px-8 py-6">
        ...
        <div className="bg-theme-surface-hover/10 rounded-b-xl overflow-hidden">
          {album.tracks.map((track, index) => {
            ...
            const trackKey = track.id.startsWith("tidal:")
              ? track.id
              : `tidal:${track.id.replace("tidal:", "")}`;
