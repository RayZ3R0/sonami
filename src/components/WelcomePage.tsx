    ...
    if (step === "intro") {
        return (
            <div
                ...
                style={{ background: theme.colors.background, color: theme.colors.textPrimary }}
            >
                <div className="max-w-md w-full text-center space-y-8">
                    <div className="space-y-4">
                        <h1 className="text-4xl font-bold tracking-tight">Welcome to Sonami</h1>
                        <p className="text-lg opacity-70">
                            Your ultimate unified music player. Connect your libraries to get started.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-4">
                        ...
                        >
                            <span className="font-semibold">Connect Subsonic / Navidrome</span>
    ...
    return (
        ...
        >
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-xs font-semibold uppercase tracking-wider mb-1 opacity-70">Server URL</label>
                        <input
                            type="text"
                            value={url}
                ...
                <button
                    ...
                    style={{ background: theme.colors.accent, color: theme.colors.textInverse }}
                >
                    {loading ? (
