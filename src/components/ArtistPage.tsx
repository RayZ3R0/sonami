      ...
      try {
        if (providerId === "tidal") {
          ...
          const [artistData, tracksData, albumsData] = await Promise.all([
            ...
            invoke<TidalTrack[]>("tidal_get_artist_top_tracks", {
              artistId: numericId,
            }),
            invoke<TidalAlbum[]>("tidal_get_artist_albums", {
              artistId: numericId,
            }),
          ]);
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {track.audioQuality === "LOSSLESS" && (
                        <span className="px-1.5 py-0.5 rounded text-[9px] bg-theme-accent/20 text-theme-accent font-bold">
                          HiFi
                        </span>
                      )}
                    </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center text-xs text-theme-muted">
                      <span>
                        {album.releaseDate?.split("-")[0] || "Unknown Year"}
                      </span>
                    </div>
                  </div>
                </div>
