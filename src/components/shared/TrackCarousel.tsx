                    ...
                    return (
                        ...
                        >
                            <div className="relative aspect-square w-full rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform group-hover:-translate-y-1 mb-3 bg-theme-surface">
                                ...
                                {/* Overlay */}
                                <div className={`absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-all duration-300 flex items-center justify-center ${isTrackPlaying ? 'bg-black/40' : 'opacity-0 group-hover:opacity-100'}`}>
                                    <div className={`w-12 h-12 rounded-full bg-theme-accent text-white flex items-center justify-center shadow-2xl transform transition-all duration-300 ${isTrackPlaying ? 'scale-100' : 'translate-y-4 group-hover:translate-y-0 group-hover:scale-100'}`}>
                                        {isTrackPlaying ? (
                            ...
                            <div className="px-1">
                                <h3 className={`font-semibold truncate text-base mb-1 transition-colors ${isCurrent ? "text-theme-accent" : "text-theme-primary group-hover:text-white"}`}>
                                    {track.title}
                                </h3>
